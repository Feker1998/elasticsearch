package com.feker.elasticsearch.controller;

import com.alibaba.fastjson.JSONObject;
import com.feker.elasticsearch.model.EsPage;
import com.feker.elasticsearch.utils.ElasticsearchUtil;
...
//    }
    ...
    public String queryDateRangeData() {
        BoolQueryBuilder boolQuery = QueryBuilders.boolQuery();
        boolQuery.must(QueryBuilders.rangeQuery("date").from("2021-01-28T11:06:01.111Z")
                .to("2021-01-28T11:06:02.921Z"));
        List<Map<String, Object>> list = ElasticsearchUtil.searchListData(indexName, esType, boolQuery, 10, null, null, null);
        return JSONObject.toJSONString(list);
    }
    ...
    @ResponseBody
    public String queryPage(@RequestParam("startPage") String startPage,@RequestParam("pageSize") String pageSize){
